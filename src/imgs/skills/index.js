...
export const Html = require('./html5.png');
...
export const RestApi = require("./rest-api.png");
export const Insomnia = require("./insomnia.png");
export const VsCode = require("./visual-studio-code.png");
